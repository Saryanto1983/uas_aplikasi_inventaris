...
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        <a href="admin" class="logo">
            ...
            <span class="logo-mini"><b>SMAN1</b>Bandung</span>
            <!-- logo for regular state and mobile devices -->
            <span class="logo-lg"><b>Aplikasi Inventaris</b></span>
        </a>
        ...
        <section class="content">
            ...
            <div class="box">
                    ...
                    <div class="box-body">
                        <div class="row">
                            <div class="col-sm-4 col-md-2">
                                <h4 class="text-center"><span class="info-box-text">Barang</span></h4>

                                <div class="color-palette-set">
                                    <a href="<?php echo site_url('barang') ?>"><center><i class="fa fa-desktop" style="font-size:48px;color:#3c8dbc"></i><center></a>
                                </div>
                            </div>
                            <!-- /.col -->
                            <div class="col-sm-4 col-md-2">
                                ...
                                <div class="color-palette-set">
                                    <a href="<?php echo site_url('peminjaman') ?>"><center><i class="fa fa-external-link" style="font-size:48px;color:#3c8dbc"></i><center></a>
                                </div>
                            </div>
                            <!-- /.col -->
                        </div>
                ...
                <div class="box-footer">
                    <center>Aplikasi Inventaris <a href="https:/sman1bdg.sch.id"><strong>SMANSA</strong></a> - 2020</center>
                </div>
                <!-- /.box-footer-->
            </div>
            <!-- /.box -->
